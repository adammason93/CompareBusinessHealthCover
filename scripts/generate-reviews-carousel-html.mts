...
<head>
  ...
  <style>html,body{margin:0;padding:0;background:transparent;min-height:auto;height:auto;overflow-x:hidden;max-width:100%;}#reviewsio-carousel-widget{max-width:100%;min-width:0;}</style>
</head>
<body>
