    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h1 className="text-4xl font-bold text-[#1D2D50] mb-4">Terms and Conditions</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          {/* Introduction */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">1. Introduction</h2>
            <p className="text-gray-700 mb-4">
              Welcome to Compare Business Healthcover ("we", "our", "us"). These Terms and Conditions govern your use of our website and services. By accessing or using our website, you agree to be bound by these terms.
            </p>
          ...
          {/* Services */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">2. Our Services</h2>
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">2.1 Comparison Service</h3>
            <p className="text-gray-700 mb-4">
              Compare Business Healthcover provides a free lead generation and comparison service for health insurance products. We connect you with insurance brokers and providers who can help you compare quotes based on the information you provide. Our brokers will contact you to discuss your requirements and assist you in finding suitable coverage.
            </p>
            
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">2.2 Information Accuracy</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">2.3 Not Financial Advice</h3>
            <p className="text-gray-700">
              Compare Business Healthcover is a lead generation service that connects you with insurance brokers and providers. We do not provide financial or insurance advice directly. The brokers and insurance specialists we connect you with are qualified to provide guidance, but you should ensure any advice is suitable for your individual circumstances before making insurance decisions.
            </p>
          </section>

          {/* User Obligations */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">3. Your Obligations</h2>
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">3.1 Accurate Information</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">3.2 Account Security</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">3.3 Prohibited Uses</h3>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">4. Quotes and Applications</h2>
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">4.1 Quote Validity</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">4.2 Application Process</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">4.3 No Guarantee</h3>
            <p className="text-gray-700">
          ...
          {/* Fees and Commission */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">5. Fees and Commission</h2>
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">5.1 Free Service</h3>
            <p className="text-gray-700 mb-4">
              Our comparison service is free for consumers. You will not be charged any fees for using our website or obtaining quotes.
            </p>

            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">5.2 Commission</h3>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">6. Intellectual Property</h2>
            <p className="text-gray-700 mb-4">
              All content on this website, including text, graphics, logos, images, and software, is the property of Compare Business Healthcover or its content suppliers and is protected by copyright and intellectual property laws.
            </p>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">7. Limitation of Liability</h2>
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">7.1 Service Availability</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2fc4bf] mb-3">7.2 Liability Exclusions</h3>
            <p className="text-gray-700 mb-4">
          ...
          {/* Third Party Links */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">8. Third Party Links</h2>
            <p className="text-gray-700">
          ...
          {/* Data Protection */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">9. Data Protection</h2>
            <p className="text-gray-700">
              We process your personal data in accordance with UK data protection laws and our{' '}
              <button
                onClick={() => onNavigate('privacy-policy')}
                className="text-[#2fc4bf] hover:underline font-medium"
              >
                Privacy Policy
              </button>
          ...
          {/* Complaints */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">10. Complaints</h2>
            <p className="text-gray-700 mb-4">
          ...
          {/* Changes to Terms */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">11. Changes to These Terms</h2>
            <p className="text-gray-700">
          ...
          {/* Governing Law */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">12. Governing Law</h2>
            <p className="text-gray-700 mb-4">
          ...
          {/* Contact */}
          <section>
            <h2 className="text-2xl font-bold text-[#1D2D50] mb-4">13. Contact Information</h2>
          ...
          <section className="bg-[#f0f9fa] p-6 rounded-lg border-l-4 border-[#2fc4bf]">
            <h2 className="text-xl font-bold text-[#1D2D50] mb-3">Acceptance of Terms</h2>
            <p className="text-gray-700">
