        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Welcome to HealthCoverComparison ("we", "our", "us"). These Terms and Conditions govern your use of our website and services. By accessing or using our website, you agree to be bound by these terms.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              All content on this website, including text, graphics, logos, images, and software, is the property of HealthCoverComparison or its content suppliers and is protected by copyright and intellectual property laws.
            </p>
            <p className="text-gray-700">
