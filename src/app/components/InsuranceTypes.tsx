        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-[#2d2f5e]">{selectedInsurance.title}</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">What It Covers</h2>
              <p className="text-gray-700 text-lg">{selectedInsurance.coverage}</p>
            </div>

            {/* Who Needs It */}
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Who Needs It?</h2>
            ...
            {/* Key Features */}
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Key Features</h2>
            ...
            {/* CTA */}
            <div className="bg-gradient-to-r from-[#2d2f5e] to-[#1f2454] rounded-lg shadow-lg p-8 text-center">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => onNavigate('home')}
              className="bg-gray-100 text-[#2d2f5e] px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors"
            >
              Get a Quote
            </button>
          </div>
