      ...
      <div className="min-h-screen bg-background py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <button
            ...
            className="mb-6 text-brand-teal hover:text-brand-teal-hover font-medium flex items-center gap-2"
          >
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-brand-navy">{selectedInsurance.title}</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h2 className="text-2xl font-bold text-brand-navy mb-4">What It Covers</h2>
              <p className="text-gray-700 text-lg">{selectedInsurance.coverage}</p>
            </div>

            {/* Who Needs It */}
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h2 className="text-2xl font-bold text-brand-navy mb-4">Who Needs It?</h2>
            ...
            {/* CTA */}
            <div className="bg-gradient-to-r from-brand-navy to-brand-navy-dark rounded-lg shadow-lg p-8 text-center">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {insuranceTypes.map((type, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6 cursor-pointer border-2 border-transparent hover:border-brand-teal"
            ...
            >
              ...
              <button className="text-brand-teal font-semibold hover:text-brand-teal-hover flex items-center gap-2">
                Learn More
                <span>→</span>
              </button>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => onNavigate('home')}
              className="bg-gray-100 text-brand-navy px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors"
            >
              Get a Quote
            </button>
          </div>
