/**
 * Official HealthCoverComparison header logo (public/logo-healthcover-comparison.png).
 */
export function BrandLogo({
  ...
  const img = (
    <img
      src="/logo-healthcover-comparison.png"
      alt="HealthCoverComparison — Find the best health insurance for you"
  ...
  if (onClick) {
    return (
      <button
        ...
        aria-label="HealthCoverComparison — Home"
      >
        {img}
      </button>
    );
