...
const components: Components = {
  ...
  ul: ({ children }) => (
    <ul className="list-disc pl-6 my-4 space-y-2 text-gray-700 marker:text-teal-700">{children}</ul>
  ),
  ol: ({ children }) => (
  ...
  blockquote: ({ children }) => (
    <blockquote className="border-l-4 border-teal-500 bg-teal-50/50 pl-4 py-1 my-4 text-gray-700 rounded-r">
      {children}
    </blockquote>
  ),
  a: ({ href, children }) => (
