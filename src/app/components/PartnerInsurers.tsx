      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {partners.map((partner, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6 border-2 border-transparent hover:border-brand-teal">
                {/* Partner Logo Placeholder */}
                <div className="h-16 bg-gradient-to-r from-brand-navy to-brand-teal rounded-lg flex items-center justify-center mb-4">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-semibold text-brand-navy">Specialties:</p>
                  <div className="flex flex-wrap gap-2">
                    {partner.specialties.map((specialty, idx) => (
                      <span
                        key={idx}
                        className="bg-brand-teal-muted text-brand-teal px-3 py-1 rounded-full text-xs font-medium"
                      >
                        {specialty}
                      </span>
                    ))}
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-12">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-brand-teal mb-2">5+</div>
              <p className="text-gray-600">Partner Insurers</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-brand-teal mb-2">FCA</div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Financial Strength</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Customer Service</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Product Range</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Competitive Pricing</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Claims Performance</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brand-navy mb-1">Regulatory Compliance</h3>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-brand-navy to-brand-navy-dark rounded-lg shadow-lg p-8 text-center mb-8">
        ...
        {/* Disclaimer */}
        <div className="bg-brand-surface border-l-4 border-brand-teal p-6 rounded-lg mb-8">
