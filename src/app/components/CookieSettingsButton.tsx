...
export function CookieSettingsButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-6 z-30 bg-gradient-to-r from-brand-navy-dark to-brand-navy text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-brand-teal/30 hover:border-brand-teal/50 group"
