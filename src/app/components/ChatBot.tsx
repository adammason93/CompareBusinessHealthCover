...
const getSmartResponse = (userMessage: string): string => {
  ...
  if (message.includes('business') || message.includes('company') || message.includes('employee')) {
    return "We provide business health insurance for companies of all sizes. It's a valuable employee benefit that improves wellbeing and reduces sick days. Contact us at 01484 773038 or email info@healthcovercomparison.co.uk for business quotes.";
  }
  ...
  if (message.includes('contact') || message.includes('phone') || message.includes('call') || message.includes('speak')) {
    return "You can reach us at: 📞 01484 773038 (Mon-Fri 9am-5pm) or 📧 info@healthcovercomparison.co.uk. We're here to help with any questions about health insurance!";
  }
  
  if (message.includes('email') || message.includes('e-mail')) {
    return "Email us at info@healthcovercomparison.co.uk and we'll respond within 24 hours. For immediate assistance, call 01484 773038.";
  }
...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hi! I'm your HealthCoverComparison assistant. How can I help you today?",
      sender: 'bot',
      timestamp: new Date(),
    },
  ]);
