      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 bg-brand-teal rounded-lg flex items-center justify-center">
              <Cookie className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-brand-navy">Cookie Policy</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          {/* Introduction */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">What Are Cookies?</h2>
          ...
          {/* Why We Use Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Why We Use Cookies</h2>
          ...
          {/* Types of Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-6">Types of Cookies We Use</h2>
              ...
              {cookieTypes.map((type, index) => (
                <div key={index} className="border-2 border-gray-200 rounded-lg p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-brand-navy mb-2">{type.title}</h3>
          ...
          {/* Specific Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Specific Cookies We Use</h2>
          ...
          {/* Third Party Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Third-Party Cookies</h2>
            <p className="text-gray-700 mb-4">
              We use services from trusted third parties that may also set cookies on your device:
            </p>
            <div className="space-y-3">
              <div className="bg-brand-surface p-4 rounded-lg">
                <h3 className="font-semibold text-brand-navy mb-2">Google Analytics</h3>
              ...
              <div className="bg-brand-surface p-4 rounded-lg">
                <h3 className="font-semibold text-brand-navy mb-2">Supabase</h3>
                <p className="text-gray-600 text-sm mb-2">
          ...
          {/* Managing Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Managing Your Cookie Preferences</h2>
            <p className="text-gray-700 mb-4">
              You have several options to manage or disable cookies:
            </p>
            
            <h3 className="text-xl font-semibold text-brand-teal mb-3">Browser Settings</h3>
            ...
            <h3 className="text-xl font-semibold text-brand-teal mb-3">Browser-Specific Instructions</h3>
            <div className="space-y-2 mb-4">
              <p className="text-gray-700">
                <strong>Chrome:</strong>{' '}
                <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
                  Cookie settings in Chrome
                </a>
              </p>
              <p className="text-gray-700">
                <strong>Firefox:</strong>{' '}
                <a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
                  Cookie settings in Firefox
                </a>
              </p>
              <p className="text-gray-700">
                <strong>Safari:</strong>{' '}
                <a href="https://support.apple.com/en-gb/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
                  Cookie settings in Safari
                </a>
              </p>
              <p className="text-gray-700">
                <strong>Edge:</strong>{' '}
                <a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
          ...
          {/* Opt Out */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Opt-Out Options</h2>
            <p className="text-gray-700 mb-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    ...
                    <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    ...
                    <a href="https://www.youronlinechoices.com/" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
                      Your Online Choices
          ...
          {/* Updates */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Changes to This Policy</h2>
            <p className="text-gray-700">
          ...
          {/* Contact */}
          <section>
            <h2 className="text-2xl font-bold text-brand-navy mb-4">Questions About Cookies?</h2>
            <p className="text-gray-700 mb-4">
          ...
          {/* Related Links */}
          <section className="bg-brand-teal-muted p-6 rounded-lg border-l-4 border-brand-teal">
            <h3 className="text-xl font-bold text-brand-navy mb-3">Related Policies</h3>
            <div className="space-y-2">
              <button
                onClick={() => onNavigate('privacy-policy')}
                className="text-brand-teal hover:underline font-medium block"
              >
                → Privacy Policy
              </button>
              <button
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="bg-brand-teal text-white px-8 py-3 rounded-lg font-semibold hover:bg-brand-teal-hover transition-colors"
          >
            Back to Home
          </button>
        </div>
