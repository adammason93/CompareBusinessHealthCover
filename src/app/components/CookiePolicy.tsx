      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-[#2d2f5e]">Cookie Policy</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          {/* Introduction */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">What Are Cookies?</h2>
            <p className="text-gray-700 mb-4">
              Cookies are small text files that are placed on your device when you visit our website. They help us provide you with a better experience by remembering your preferences and understanding how you use our site.
            </p>
            <p className="text-gray-700">
              This Cookie Policy explains what cookies are, how we use them, and your choices regarding cookies on HealthCoverComparison.
            </p>
          </section>

          {/* Why We Use Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Why We Use Cookies</h2>
          ...
          {/* Types of Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-6">Types of Cookies We Use</h2>
              ...
              {cookieTypes.map((type, index) => (
                <div key={index} className="border-2 border-gray-200 rounded-lg p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#2d2f5e] mb-2">{type.title}</h3>
          ...
          {/* Specific Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Specific Cookies We Use</h2>
          ...
          {/* Third Party Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Third-Party Cookies</h2>
            <p className="text-gray-700 mb-4">
              We use services from trusted third parties that may also set cookies on your device:
            </p>
            <div className="space-y-3">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-[#2d2f5e] mb-2">Google Analytics</h3>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-[#2d2f5e] mb-2">Supabase</h3>
                <p className="text-gray-600 text-sm mb-2">
          ...
          {/* Managing Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Managing Your Cookie Preferences</h2>
            <p className="text-gray-700 mb-4">
          ...
          {/* Opt Out */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Opt-Out Options</h2>
            <p className="text-gray-700 mb-4">
          ...
          {/* Updates */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Changes to This Policy</h2>
            <p className="text-gray-700">
          ...
          {/* Contact */}
          <section>
            <h2 className="text-2xl font-bold text-[#2d2f5e] mb-4">Questions About Cookies?</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-2">
                <strong>Email:</strong>{' '}
                <a href="mailto:info@healthcovercomparison.co.uk" className="text-[#0ebcc8] hover:underline">
