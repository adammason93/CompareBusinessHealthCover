...
const sampleReviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I was overwhelmed trying to compare different health insurance options, but Compare Business Health Cover made it so easy. They explained everything clearly and helped me find the perfect policy for my family. Outstanding service!",
