      ...
      <div className="bg-gradient-to-r from-[#2d2f5e] to-[#1f2454] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-gray-300 space-y-1">
            <p className="text-xl">Healthcovercomparison</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              These Terms and Conditions ("Terms") govern your use of the Healthcovercomparison website ("Website").
            </p>
          ...
          {/* 2. About Healthcovercomparison */}
          <section className="border-t border-gray-200 pt-8">
            <div className="flex items-center gap-3 mb-4">
              <Building className="w-6 h-6 text-teal-600" />
              <h2 className="text-2xl font-bold text-gray-900">2. About Healthcovercomparison</h2>
            </div>
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison is an online comparison and introducer service that connects individuals and businesses with Financial Conduct Authority (FCA) regulated insurance brokers and providers.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@healthcovercomparison.co.uk" className="text-teal-600 hover:text-teal-700">
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison provides an online platform that allows users to request information and quotes for health insurance products.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison does not provide financial, legal, or insurance advice.
            </p>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison acts solely as an introducer.
            </p>
            <ul className="space-y-2 ml-6">
              <li className="text-gray-700 flex items-start gap-2">
                <span className="text-teal-600 mt-1.5">•</span>
              ...
              <li className="text-gray-700 flex items-start gap-2">
                <span className="text-teal-600 mt-1.5">•</span>
                <span>Healthcovercomparison is not responsible for the advice, recommendations, products, or services provided by third parties</span>
              </li>
            </ul>
          </section>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison introduces users to third-party insurance brokers and providers.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              To the fullest extent permitted by law, Healthcovercomparison shall not be liable for:
            </p>
            <ul className="space-y-2 ml-6 mb-4">
              <li className="text-gray-700 flex items-start gap-2">
                <span className="text-teal-600 mt-1.5">•</span>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              All Website content, including text, logos, graphics, and design, is owned by or licensed to Healthcovercomparison.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              You may not:
            </p>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              You agree to indemnify and hold harmless Healthcovercomparison against any claims, damages, or losses arising from:
            </p>
            <ul className="space-y-2 ml-6">
              <li className="text-gray-700 flex items-start gap-2">
                <span className="text-teal-600 mt-1.5">•</span>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-3">
              <p className="font-semibold text-gray-900 mb-3">Healthcovercomparison</p>
              <div className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-teal-600 mt-1 flex-shrink-0" />
                <div>
                  <p className="font-semibold text-gray-900">Email:</p>
