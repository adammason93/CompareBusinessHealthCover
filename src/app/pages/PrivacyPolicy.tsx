        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Healthcovercomparison ("we", "us", "our") is committed to protecting your privacy and handling your personal data transparently and securely.
            </p>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Healthcovercomparison is a health insurance comparison service that connects users with FCA-regulated insurance brokers and providers.
            </p>
