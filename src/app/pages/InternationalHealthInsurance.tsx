...
interface InternationalHealthInsuranceProps {
  onGetStarted: () => void;
}

export function InternationalHealthInsurance({ onGetStarted }: InternationalHealthInsuranceProps) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8">
              Global health coverage for expats, frequent travelers, and international workers. Stay protected wherever you are in the world.
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl mb-6 text-gray-900">Worldwide Healthcare Coverage</h2>
              <p className="text-gray-600 mb-4">
                International health insurance provides comprehensive medical coverage across multiple countries. Whether you're an expat, digital nomad, or frequent business traveler, stay protected globally.
              </p>
              <p className="text-gray-600 mb-4">
                Access quality healthcare in your country of residence and when traveling, with the flexibility to choose treatment locations worldwide.
              </p>
            </div>
            <div>
              <h2 className="text-3xl mb-6 text-gray-900">Global Benefits</h2>
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-500 flex-shrink-0" />
                  <span className="text-gray-700">Multi-Currency Payments</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-500 flex-shrink-0" />
                ...
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-teal-500 flex-shrink-0" />
                  <span className="text-gray-700">Repatriation Cover</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16" style={{ backgroundColor: '#0ebcc8' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl text-white mb-6">
            Ready to Compare International Health Insurance?
          </h2>
          <p className="text-xl text-white mb-8">
            Get global coverage tailored to your needs
          </p>
          <Button 
            onClick={onGetStarted}
