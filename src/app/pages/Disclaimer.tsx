          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p className="mb-2">
                      <strong>Compare Business Health Cover</strong> is a trading name for <strong>MASON & HALL DIGITAL LTD</strong> which is a registered company in England and Wales.
                    </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                Compare Business Health Cover is a website designed to help people looking into health insurance. We are <strong>not</strong> a private health insurance company or a broker and are not able to offer any advice on any regulated financial services products.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                If you enter an agreement through one of our partners then you do so at your own risk and must comply with their terms and conditions. Compare Business Health Cover will not be liable for any loss or damage in connection with using this website.
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                Compare Business Health Cover does not guarantee the total accuracy of the information on our site and does not accept any liability for any inaccuracies or errors.
              </p>
              <p className="text-gray-700">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700">
                Compare Business Health Cover itself is not authorized or regulated by the FCA as we do not provide financial advice or arrange insurance contracts.
              </p>
            </div>
