          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p className="mb-2">
                      <strong>HealthCoverComparison</strong> is a trading name for <strong>MASON & HALL DIGITAL LTD</strong> which is a registered company in England and Wales.
                    </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                HealthCoverComparison is a website designed to help people looking into health insurance. We are <strong>not</strong> a private health insurance company or a broker and are not able to offer any advice on any regulated financial services products.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                If you enter an agreement through one of our partners then you do so at your own risk and must comply with their terms and conditions. HealthCoverComparison will not be liable for any loss or damage in connection with using this website.
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                HealthCoverComparison does not guarantee the total accuracy of the information on our site and does not accept any liability for any inaccuracies or errors.
              </p>
              <p className="text-gray-700">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700">
                HealthCoverComparison itself is not authorized or regulated by the FCA as we do not provide financial advice or arrange insurance contracts.
              </p>
            </div>
            ...
            <div className="mb-12 p-6 bg-teal-50 rounded-xl">
              ...
              <div className="space-y-2 text-gray-700">
                <p><strong>Email:</strong> <a href="mailto:info@healthcovercomparison.co.uk" className="text-teal-600 hover:text-teal-700">info@healthcovercomparison.co.uk</a></p>
